...
MODES = ('list-cfg', 'copy-cfg', 'log-dataset', 'check-custom-dataset',
         'train', 'test', 'chat', 'convert', 'preprocess',, 'mmbench','pathvqa',
         'eval_refcoco','zero_shot','pmcvqa')
...
def pathvqa():
    from xtuner.tools import pathvqa
    return pathvqa.__file__
...
def zero_shot():
    from xtuner.tools import zero_shot
    return zero_shot.__file__

def pmcvqa():
    from xtuner.tools import pmcvqa
    return pmcvqa.__file__
...
MAP_FILE_FUNCS = [
    ...
    mmbench, pathvqa, pth_to_hf, merge, split, arxiv_preprocess, eval_refcoco, zero_shot, pmcvqa, 
