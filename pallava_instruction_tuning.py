...
pretrained_pth = 'absolute path of domain alignment model weight'
# Data
data_root = '/home/ubuntu/public-Datasets/Medical_DataSet/'
# data_path = data_root + 'sft_json'
data_path = data_root + 'sft_hfformat'
...
evaluation_inputs = ['Describe the image.','Which organ did this tissue section come from?'] 
...
optim_wrapper = dict(
    ...
    paramwise_cfg = dict(custom_keys={'projector': dict(lr_mult=1e-4 / 2e-4),'llm':dict(lr_mult=2e-4 / 2e-4)}),
